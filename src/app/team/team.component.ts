...
export class TeamComponent implements OnInit {
    ...
    constructor(private router: Router, private route:ActivatedRoute, private http:Http) {
         ...
         */
        this.players$ = http.get(`${API_ROOT}${this.routeData.apiRoute}/players?team_id=${this.slug}&page=${this.page}`, {headers: HEADERS})
          .map(res => res.json())
    ...
    goTo(page: number): void {
        ...
        this.page = page;
        this.players$ = this.http.get(`${API_ROOT}${this.routeData.apiRoute}/players?team_id=${this.slug}&page=${this.page}`, {headers: HEADERS})
          .map(res => res.json())
          .map(json => json.players);
    }
